 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
     ...
     if (enterAmount > enterSAmount) {
      ...
      var textNode = document.createTextNode(`$${enterAmount} is sent from sender with Email-id ${enterSName}@email.com to recepient 
      with Email-id ${enterName}@email.com on ${Date()}.`);
